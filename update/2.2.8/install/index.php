...
Class mlife_smsservices extends CModule
{
        ...
        function DoInstall() {
			...
			$eventManager->registerEventHandler('messageservice', 'onGetSmsSenders', $this->MODULE_ID, '\Mlife\Smsservices\Handlers', 'onGetSmsSenders');
			//$eventManager->registerEventHandler('main', 'onBeforeSendSms', $this->MODULE_ID, '\Mlife\Smsservices\Handlers', 'onBeforeSendSms');
        ...
        function DoUninstall() {
			...
			UnRegisterModuleDependences("messageservice", "onGetSmsSenders", $this->MODULE_ID, '\Mlife\Smsservices\Handlers', "onGetSmsSenders");
			//UnRegisterModuleDependences("main", "onBeforeSendSms", $this->MODULE_ID, '\Mlife\Smsservices\Handlers', "onBeforeSendSms");
