...
?>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="login"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_PASSW")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "passw", "","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="passw"></td>
	</tr>
	<tr>
		...
		$val = \Bitrix\Main\Config\Option::get($module_id, "sender", ".","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="sender">
		<?php }?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="cacheotp"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_BALANCECACHE")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "cachebalance", "3600","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="cachebalance"></td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="login_r"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_PASSW")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "passw_r", "","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="passw_r"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_OTP")?>:</td>
		<td>
		...
		$val = \Bitrix\Main\Config\Option::get($module_id, "sender_r", ".","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="sender_r">
		<?php }?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="cacheotp_r"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_BALANCECACHE")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "cachebalance_r", "3600","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="cachebalance_r"></td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="login_app"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_PASSW")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "passw_app", "","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="passw_app"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_OTP")?>:</td>
		<td>
		...
		$val = \Bitrix\Main\Config\Option::get($module_id, "sender_app", ".","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="sender_app">
		<?php }?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="cacheotp_app"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_BALANCECACHE")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "cachebalance_app", "3600","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="cachebalance_app"></td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="limitsms"></td>
	</tr>
	<tr>
		<td><?=Loc::getMessage("MLIFESS_OPT_LIMITSMS2")?>:</td>
		<td>
			<?php $val = \Bitrix\Main\Config\Option::get($module_id, "limittimesms", "600","");?>
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="limittimesms"></td>
	</tr>
	<tr>
...
foreach($arSites as $siteId=>$siteName){
	...
	<tr>
		...
		<td>
			...
			<input type="text" size="35" maxlength="255" value="<?=htmlspecialcharsbx($val)?>" name="admin_phone_<?=$siteId?>_<?=$persid?>"></td>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_cancelY_<?=$persid?>" id="mess_status_<?=$siteId?>_cancelY_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_cancelN_<?=$persid?>" id="mess_status_<?=$siteId?>_cancelN_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_deliveryY_<?=$persid?>" id="mess_status_<?=$siteId?>_deliveryY_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_deliveryN_<?=$persid?>" id="mess_status_<?=$siteId?>_deliveryN_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_payY_<?=$persid?>" id="mess_status_<?=$siteId?>_payY_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_payN_<?=$persid?>" id="mess_status_<?=$siteId?>_payN_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_new_<?=$persid?>" id="mess_status_<?=$siteId?>_new_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<textarea style="width:90%;" name="mess_status_<?=$siteId?>_new2_<?=$persid?>" id="mess_status_<?=$siteId?>_new2_<?=$persid?>"><?=htmlspecialcharsbx($val)?></textarea>
		</td>
	</tr>
	<?php
	}?>
